...
import ListHeader from '../../components/shopDetails/listHeader/listHeader';
import TabsSmart from  './tabs/tabs';
...
class ShopDetails extends Component{
    ...
    render(){
        ...
        return (
            <div className='shopDetails_box' style={{"overflow":"hidden"}}>
                <div className="shopDetails_wrap" style={styles}>
